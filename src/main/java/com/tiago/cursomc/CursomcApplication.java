...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Endereco e1 = new Endereco(null, "Rua Flores", "65", "Proxima a quadra de areia", "Novo Milenio", "88512395",
				cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Otacilio", "75", "Proxima ao Mercado Myatã", "Petrópolis", "88769403",
				cli1, c2);
